import { GridTileImage } from "@/src/components/grid/tiles";
...
import { HIDDEN_PRODUCTS_TAGS } from "@/src/lib/constants";
...
export async function generateMetadata({
  ...
  const indexable = !product.tags.includes(HIDDEN_PRODUCTS_TAGS);
